package com.usn.patterns.observer;
	...
	public void run() {
		...
		for (int i = 1; i <= 2; i++) {
			...
			try {
				...
				// Use Thread.sleep(startTime * 1000); to make sleep time
				// variable
			...
			System.out.println(stock + " Updated Price: " + df.format(price) + "  Chg: " + df.format(randNum));
